...
Avatar::Avatar() {
    callBackTmp = std::bind(&avatarExtraAudioFeature, std::placeholders::_1, std::placeholders::_2,
...
void Avatar::run(const char *audioPath) {
    ...
    mAvatarHandler->run(audioFeatRows, audioFeatCols, audioFeatStride, audioFeats);
