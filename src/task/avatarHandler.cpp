...
std::vector<int64_t> avatarHandler::onnxinference(int rows, int cols, int stride, float *feats, float **result) {
    auto conf = config_A->getConfig();
...
void avatarHandler::wavToLip(float *pdata) {
...
vector<Mat> avatarHandler::getWavToLipImgs(int rows, int cols, int stride, float *feats) {
    auto                       conf   = config_A->getConfig();
    float                      *pdata = nullptr;
