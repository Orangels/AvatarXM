...
std::vector<int64_t> avatarHandler::onnxinference(int rows, int cols, int stride, float *feats, float *pdata) {
    auto conf = config_A->getConfig();
...
void avatarHandler::getWavToLipImgs(int rows, int cols, int stride, float *feats) {
    float *pdata;
